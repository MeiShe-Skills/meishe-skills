...
PLATFORM_SCRIPTS = {
    "react-native": SKILL_ROOT / "scripts" / "integrate_react_native.py",
}
...
def write_flutter_android_aar(
    path: Path,
    *,
    include_native_libraries: bool,
    include_beauty_shape_resources: bool = True,
) -> None:
    path.parent.mkdir(parents=True, exist_ok=True)
